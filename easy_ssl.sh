...
# This script creates the subdomain for your domain name on Route53 and automatically installs SSL for Ant Media Server.
# Aws credentials should be added to the .env file.
# Example Usage
# bash -x ./easy_ssl.sh -k ../ovh/id_ovh_rsa -u ubuntu -i 51.89.119.240 -d ant99.antmedia.cloud
